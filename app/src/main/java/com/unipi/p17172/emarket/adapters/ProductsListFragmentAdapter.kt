 ...
 */
open class ProductsListFragmentAdapter(
    private val fragment: Fragment,
    private var list: ArrayList<Product>
) : RecyclerView.Adapter<ProductsListFragmentAdapter.ProductsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductsViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            GlideLoader(fragment.requireContext()).loadProductPictureWide(model.iconUrl, imgViewIcon)
            ...
            txtViewWeight.text = String.format(
                fragment.getString(R.string.txt_format_weight),
                model.weight,
                model.weightUnit
            )
            ...
            checkboxFavorite.setOnClickListener {
                ...
                FirestoreHelper().addToFavorites(fragment, favorite)
//                if (isInFavorites) {
//                    Log.d("", "in favs")
//                    FirestoreHelper().deleteFavoriteProduct(fragment, model.id)
//                }
//                else {
//                    Log.d("", "not in favs")
//                    val favorite = Favorite(
...
//                }
        ...
        holder.itemView.setOnClickListener {
            IntentUtils().goToProductDetailsActivity(fragment.requireContext(), model.id, isInFavorites)
        }
    }
