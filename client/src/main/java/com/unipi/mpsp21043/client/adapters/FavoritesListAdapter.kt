...
import com.unipi.mpsp21043.client.databinding.ItemFavoriteProductBinding
...
open class FavoritesListAdapter(
    ...
    override fun onBindViewHolder(holder: FavoritesViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { IntentUtils().goToProductDetailsActivity(context, model.productId) }
    }
