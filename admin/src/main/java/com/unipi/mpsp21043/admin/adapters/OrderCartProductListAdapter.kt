...
import com.unipi.mpsp21043.admin.databinding.ItemProductWideBinding
import com.unipi.mpsp21043.admin.models.Cart
...
open class OrderCartProductListAdapter(
    ...
    override fun onBindViewHolder(holder: OrderProductViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            textViewStock.text = model.cartQuantity.toString()
        }
